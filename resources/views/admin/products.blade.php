...
@section('content')
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#deleteProductModal-{{$product->id}}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
    ...
    @foreach($products as $product)
        <!-- Modal -->
        <div class="modal fade" id="deleteProductModal-{{$product->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{route('adminDeleteProduct', $product->id)}}" method="POST">
                            @csrf
